...
function Playvideo() {
   ...
   const [commentData, setCommentData] = useState([])
    ...
    const fetchOtherData = async () => {
        // Check if apiData is not null before making the request
    ...
    <div className=' play-video'>
       ...
       <iframe src={`https://www.youtube.com/embed/${videoId}?autoplay=1`}  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        ...
        <div className="play-video-info">
            <p>{apiData?value_convertor(apiData.statistics.viewCount):"16K"} Views &bull;  {moment(apiData?apiData.snippet.publishedAt:"2 day ago").fromNow()} </p>
            <div>
        ...
        <div className="publisher">
            ...
            <div >
                <p>{apiData?apiData.snippet.channelTitle:""} 
                </p>
        ...
        <div className="vid-description">
           ...
           {commentData.map((item,index)=>{
            ...
            return(
                ...
                <div>
                    <h3>{item.snippet.topLevelComment.snippet.authorDisplayName} <span>  {moment(item.snippet.topLevelComment.snippet.publishedAt).fromNow()}  ago</span></h3>
